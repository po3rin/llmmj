import asyncio
from agents.agents import run, create_session
from google.adk.agents import LoopAgent
from google.adk.runners import Runner

from agents.agents import get_mahjong_supervisor_agent, get_final_output_json_generator_agent, CheckStatusAndEscalate
    ...
    root_agent = LoopAgent(
        ...
        sub_agents=[
            ...
            CheckStatusAndEscalate(
                name="StopChecker", expected_han=3, expected_fu=50
            )
        ]
    )
